...
export default function GroupInfo({ isDark }) {
  return (
    <div
      className="h-[40vh] bg-[#222] flex flex-col"
      style={isDark ? {} : { background: "#eee" }}
    >
      <div className="flex h-[70px] items-center justify-between px-4">
        <p
          className="font-josefin font-semibold text-[18px]"
          style={isDark ? {} : { color: "#444" }}
        >
          GroupInfo
        </p>
      </div>
      ...
      <div className=" p-2 px-4 flex">
        ...
        <div className="mx-2 flex-1 flex flex-col justify-center">
          ...
          <div className="flex text-[12px] items-center">
            <p
              className="font-josefin text-[13px]"
      ...
      <div className="m-2" style={isDark ? {} : { color: "#555" }}>
      ...
      <div
        className="flex flex-1 px-4 border-y-[1px] border-[#444] items-center justify-between"
        style={isDark ? {} : { borderColor: "#aaa" }}
      >
        <div className="font-josefin" style={isDark ? {} : { color: "#444" }}>
          Members
        </div>
